        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Mot de passe oublié</span></li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="email" id="frm-login-uname" name="email" placeholder="Type your email address" :value="old('email')" required autocomplete="">
                                    </fieldset>

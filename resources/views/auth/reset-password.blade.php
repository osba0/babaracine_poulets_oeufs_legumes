        ...
        <div class="container">
            ...
            <div class="wrap-breadcrumb">
                <ul>
                    ...
                    <li class="item-link"><span>Rénitialiser mot de passe</span></li>
                </ul>
            </div>
            <div class="row">
                            ...
                            <div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('password.update') }}">
                                    ...
                                    <fieldset class="wrap-title">
                                        <h3 class="form-title">Rénitialiser mot de passe</h3>                                      
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-login-uname">Email:</label>
                                        <input type="email" id="frm-login-uname" name="email" placeholder="Type your email address" :value="{{ $request->email }}" required autocomplete="">
                                    </fieldset>
                                    ...
                                    <input type="submit" class="btn btn-submit" value="Rénitialiser mot de passe" name="submit">
                                </form>
                            </div>                                              
                        </div>

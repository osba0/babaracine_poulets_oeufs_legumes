            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-weight">Poids: <span class="product-weight"> {{ $product->weight }} kg</span></div>
                        
                        <div class="stock-info  {{ $product->stock_status=='instock'?'in-stock':'out-stock' }}">
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="add_infomation">
                                <table class="shop_attributes">
                                    <tbody>
                                        <tr>
                                            <th>Poids</th><td class="product_weight">{{ $product->weight }} kg</td>
                                        </tr>
                                        <tr>
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="wrap-price"><span class="product-price">{{ $p_product->regular_price }} FCFA</span></div>
                                    </div>
                                </div>
                            </li>
                            @endforeach
                        ...
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                <div class="product-thumnail">
                                    ...
                                    <div class="wrap-btn">
                                        <a href="{{ route('product.details', ['slug'=>$r_product->regular_price])}}" class="function-link">quick view</a>
                                    </div>
                                </div>
                                <div class="product-info">
                                    <a href="{{ route('product.details', ['slug'=>$r_product->slug] )}}" class="product-name"><span>{{ $r_product->name }}</span></a>
                                    <div class="wrap-price"><span class="product-price">{{ $r_product->regular_price }} FCFA</span></div>
                                </div>
                            </div>
                            @endforeach
